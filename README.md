<h1>Egg Hatchery<img align="right" src="./Data/images/canvas1.png" width="100px"></h1>

Content library that allows users to automate the tracking and hatching of eggs collected.

[Table of Contents](https://github.com/Shadow-Draconic-Development/Avrae-Egg-Hatchery/blob/main/ToC.md)
...
## Help
Ensure that you import egg settings by going to [import](https://github.com/Shadow-Draconic-Development/Avrae-Egg-Hatchery/tree/main/Code/import/import.md).
